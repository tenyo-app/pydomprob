class TestDispatcherExceptionImports:
    def test_base_dispatcher_exception(self):
        # Arrange
        from domprob.exceptions import DispatcherException as AliasDispatcherException
    ...
    def test_req_instrum_exception(self):
        # Arrange
        from domprob.exceptions import ReqInstrumException as AliasReqInstrumException
